...
#ifndef __IDA_RENAME_H__
#define __IDA_RENAME_H__
...
{
    struct iatt attr;
    struct iatt attr_ppre_old;
    struct iatt attr_ppost_old;
    struct iatt attr_ppre_new;
    struct iatt attr_ppost_new;
    dict_t * xdata;
} ida_args_rename_cbk_t;
